...
import { Layout, Home, BarChart2, Users, FileText, LogOut, CreditCard } from 'lucide-react'; // Added CreditCard icon
  ...
  return (
    <div className="w-64 bg-[#1A1F37] p-6 flex flex-col min-h-screen">
      ...
      <nav className="space-y-2">
        ...
        <SidebarLink to="/analytics" icon={BarChart2} text="Analytics" />
