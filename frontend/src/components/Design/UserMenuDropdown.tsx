...
const UserMenuDropdown = () => {
  ...
  const notifications = [
    ...
    },
    {
      ...
      description: 'Your application for Senior Developer has been viewed',
      time: '1h ago',
      unread: true
    },
    {
                ...
                <div className="space-y-1">
                  {menuItems.map((item) => (
                    ...
                    >
                      ...
                      {item.count && (
                        <span className="px-2 py-0.5 text-xs font-medium text-slate-400 bg-slate-800/50 rounded-full">
                          {item.count}
                        </span>
                      )}
