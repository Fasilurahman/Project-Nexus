...
const ProjectDashboard = () => {
  ...
  const getUniqueTeamMembers = (projects: Project) => {
    ...
    projects.forEach((project: Project) => {
      ...
      project.teamMembersDetails.forEach((member) => {
    ...
    console.log(lastmembers, "lastMembers");
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    {projects.map((member, index) => (
                      <div key={index} className="flex items-center gap-3">
                        <img
                          src={member.teamLeadId.profilePic}
                          alt={member.name}
                          className="w-10 h-10 rounded-lg ring-2 ring-indigo-500/20"
                        />
                        <div>
                    ...
                    {projects.map((member) =>
                      member.teamMembersDetails.map((teamMember, index) => (
                        <div key={index} className="flex items-center gap-3">
                          <img
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-400">
                              {teamMember.role ? "Employee" : teamMember.role}
                            </p>
                          </div>
                        </div>
                      ))
